...
const CloseAppointment = (props) => {
    ...
    const handleSubmission = () => {
        ...
        axios.put(`${IP_ADDRS}/api/doctor/appointment/upload_images/${appointment.appointmentId}/${appointment.patientId}`, formData, { headers: { "Authorization": `Bearer ${doctor.jwt}` } })
            .then(res => {
    ...
    return (
        <div style={{ "marginLeft": "100px" }}>
            ...
            <button onClick={handleSubmission} className='btn btn-primary' style={{ 'margin': '100px' }}>Upload</button>&emsp;
