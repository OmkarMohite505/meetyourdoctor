    ...
    useEffect(() => {
      ...
      const submitData=(e)=>{
        ...
        console.log(formData);
         axios.post(`http://localhost:8080/api/patient/profile_picture/${data.patientId}`,formData,
...
{imgFlag ?  <img src={URL.createObjectURL(imageFile)} style={{'height':'200px','width':'200px'}}></img>
            : <img src={`http://localhost:8080/api/image/ROLE_PATIENT/${data.patientId}`} style={{'height':'400px','width':'400px'}}></img>}
